    ...
    <section className="pb-5">
      ...
      <div className="mt-5 grid gap-8 md:grid-cols-3">
        <div className="flex flex-col items-center gap-4">
          ...
          <h5 className="text-center text-xl md:text-2xl font-bold text-white">
            Ready for the future
          </h5>
          <p className="text-lg md:text-xl font-semibold text-gray-400 text-center">
            A flexible foundation that evolves <br /> with complex ecosystem.
          </p>
        </div>
        <div className="flex flex-col items-center gap-4">
          <div className="p-2 bg-gradient-to-b from-purple-600 to-sky-600 w-fit rounded-full">
